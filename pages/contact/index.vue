<template>
    ...
    <div class="bg-sky-50 h-full w-full flex">
      ...
      <div class="flex bg-white border h-fi rounded-lg mx-12 my-12">
         <div class="flex bg-sky-50 border rounded-lg h-fit mx-12 my-4">
            <div class="flex">
                <img src="~/assets/me2.jpg" alt="" class="mx-28 my-12 h-96 transition scale-100 hover:scale-110  rounded-lg">
            </div>
          <div class="text-wrap ">
